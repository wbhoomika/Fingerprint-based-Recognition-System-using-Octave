...
clear all;
close all;
pic1 = imread('C:\Users\Bhoomika\Desktop\1.jpg');
pic2 = imread('C:\Users\Bhoomika\Desktop\1.jpg'); % ** SAME image
%pic2 = imread('C:\Users\Bhoomika\Desktop\2.jpg'); % ** DIFFERENT image
figure
subplot(1,2,1);
imshow(pic1)
subplot(1,2,2);
